...
// define this to strip uae crap from the final executable
#define RELEASE
...
#define debug_clear(...)
#define debug_rect(...)
#define debug_filled_rect(...)
#define debug_text(...)
#define debug_start_idle(...)
#define debug_stop_idle(...)
#define debug_register_bitmap(...)
#define debug_register_palette(...)
#define debug_register_copperlist(...)
